...
/// Activates stamp brush mode with the given stamp asset key.
class StampBrushActivated extends StickerEvent {
  const StampBrushActivated(this.stampId);
  final String stampId;
  @override
  List<Object?> get props => [stampId];
}

/// Deactivates stamp brush mode.
class StampBrushDeactivated extends StickerEvent {
  const StampBrushDeactivated();
  @override
  List<Object?> get props => [];
}

/// Places a batch of stamp stickers generated by the brush engine.
class StampBrushTrailPlaced extends StickerEvent {
  const StampBrushTrailPlaced(this.stamps);
  final List<StickerElement> stamps;
  @override
